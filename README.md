...
- [📖 greeting-rails-react ](#-greeting-rails-react-)
...
**greeting rails react** is a project that demonstrates how to build a Rails API with a React frontend.
...
```sh
  cd your-folder
  git clone https://github.com/jugosack/hello-rails-react.git
```
...
Feel free to check the [issues page](hhttps://github.com/jugosack/hello-rails-react/issues).
